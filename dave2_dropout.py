...
train.train( dave2(), 'dave2-dropout', True, False, True, 5, 0.5)
train.train( dave2(), 'dave2-dropout', True, True, True, 5, 0.5)
train.train( dave2(), 'dave2-dropout', False, False, True, 5, 0.5)
